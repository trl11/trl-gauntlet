...
describe("SeriesPicker", () => {
  it("stays flat with full names below the grouping threshold", () => {
  ...
  it("groups a large set into one section per prefix", () => {
  ...
  it("filtering flattens matches across groups", async () => {
    render(<SeriesPicker names={LARGE} selected={[]} onChange={vi.fn()} />);
    await userEvent.type(screen.getByPlaceholderText("Filter series"), "field2");
