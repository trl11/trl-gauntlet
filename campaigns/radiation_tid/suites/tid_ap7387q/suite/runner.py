...
Component      AP7387Q-50Y-13
Test vehicle   PRE-10165
Host           Power supply
Fixture        5-1

To implement: TBD — no software approach defined in the test plan yet.

Hardware       A load is needed.
Test plan edits outstanding:
  - Change the input voltage from 34V to 12V.
"""
...
class TidAp7387qProfile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidAp7387qProfile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_ap7387q",
    profile_model=TidAp7387qProfile,
    iterate=_iterate,
    evaluate=_evaluate,
