...
class TidImx492Profile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidImx492Profile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_imx492",
    profile_model=TidImx492Profile,
    iterate=_iterate,
    evaluate=_evaluate,
