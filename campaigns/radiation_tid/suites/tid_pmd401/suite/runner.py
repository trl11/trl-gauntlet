...
Component      PMD401
Test vehicle   PMD401
Host           Linux laptop / Windows
Fixture        Standalone-PMD401
...
class TidPmd401Profile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidPmd401Profile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_pmd401",
    profile_model=TidPmd401Profile,
    iterate=_iterate,
    evaluate=_evaluate,
