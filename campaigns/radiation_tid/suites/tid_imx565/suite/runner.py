...
class TidImx565Profile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidImx565Profile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_imx565",
    profile_model=TidImx565Profile,
    iterate=_iterate,
    evaluate=_evaluate,
