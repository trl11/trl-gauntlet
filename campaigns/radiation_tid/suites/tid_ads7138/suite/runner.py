...
Component      ADS7138QRTERQ1
Test vehicle   PRE-10161
Host           Raspberry Pi
Fixture        1-1

To implement:
  - Read the data from 2 ADCs across 4 inputs, and set 2 outputs.

Hardware       Waiting on PRE-10161.
Test plan edits outstanding:
  - Update the block diagram to show the 2 ADCs, 4 inputs and 2 outputs.
  - Update the part number on the block diagram.
"""
