...
Component      SN65HVD76D
Test vehicle   PRE-10173
...
class TidSn65hvd76Profile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidSn65hvd76Profile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_sn65hvd76",
    profile_model=TidSn65hvd76Profile,
    iterate=_iterate,
    evaluate=_evaluate,
