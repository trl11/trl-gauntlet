...
Component      MAX96792AGTM/VY+
Test vehicle   LI-GMSL3-USB3.2
Host           JM201
Fixture        3-1

To implement:
  - Execute a continuous capture loop monitoring image reception status (success/fail),
  - dropped frame count, corruption count, and data rate in Mbps.

Hardware       Waiting on LI-IMX728-GMSL3-070H.
...
class TidMax96792Profile(BaseModel):
