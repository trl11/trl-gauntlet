"""Profile model for the MAX96792 GMSL3 Deserializer TID suite."""
...
class TidMax96792Profile(BaseModel):
    """One irradiation of the MAX96792AGTM/VY+, and what counts as a healthy link."""
    ...
    part_address: str = Field(
        ...
        description=(
            "I2C address of the MAX96792AGTM/VY+, the part under the beam. Both ends are "
    ...
    def _check_sample_period(self) -> TidMax96792Profile:
