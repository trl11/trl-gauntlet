...
class TidTle9250Profile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidTle9250Profile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_tle9250",
    profile_model=TidTle9250Profile,
    iterate=_iterate,
    evaluate=_evaluate,
