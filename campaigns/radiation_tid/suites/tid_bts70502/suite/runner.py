...
Test plan edits outstanding:
  - Adjust the placement of the shunt.
"""
...
class TidBts70502Profile(BaseModel):
...
def _evaluate(outcomes: list[IterationOutcome], profile: TidBts70502Profile) -> tuple[bool, str] | None:
...
SPEC = SuiteSpec(
    name="tid_bts70502",
    profile_model=TidBts70502Profile,
    iterate=_iterate,
    evaluate=_evaluate,
